...
- (void)buttonPressed:(UIButton *)sender; {
    ...
    [self.tabBarItem setBadgeValue:[NSString stringWithFormat:@"%d", (int) [self calculateGlassesOfWhiskey:numberOfBeers alcoholByVolume:[self.beerPercentTextField.text floatValue]]]];
}
